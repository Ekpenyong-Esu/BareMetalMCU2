...
/* ARGB8888 colour channel layout --------------------------------------------*/

#define DMA2D_CHANNEL_MAX 255U   /**< Largest value of one 8-bit colour channel */
#define DMA2D_CHANNEL_MASK 0xFFU /**< Bits of one 8-bit colour channel */
#define DMA2D_ALPHA_SHIFT 24     /**< Bit position of the alpha channel */
#define DMA2D_RED_SHIFT 16       /**< Bit position of the red channel */
#define DMA2D_GREEN_SHIFT 8      /**< Bit position of the green channel */
