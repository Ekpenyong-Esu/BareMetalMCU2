...
void CRC_RegisterCompleteCallback(CRC_CompleteCallback callback) { s_completeCallback = callback; }
void CRC_RegisterErrorCallback(CRC_ErrorCallbackFn callback) { s_errorCallback = callback; }
