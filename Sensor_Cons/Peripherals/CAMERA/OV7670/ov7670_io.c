...
OV7670_StatusTypeDef OV7670_WriteReg(OV7670_Handle_t *hov7670, uint8_t reg, uint8_t value) {
    ...
    if (I2C_Mem_Write(&hov7670->device, reg, I2C_MEMADD_SIZE_8BIT, &value, 1, OV7670_I2C_TIMEOUT) !=
        I2C_OK) {
...
OV7670_StatusTypeDef OV7670_ReadReg(OV7670_Handle_t *hov7670, uint8_t reg, uint8_t *value) {
    ...
    if (I2C_Mem_Read(&hov7670->device, reg, I2C_MEMADD_SIZE_8BIT, value, 1, OV7670_I2C_TIMEOUT) !=
        I2C_OK) {
        return OV7670_I2C_ERROR;
    }
...
OV7670_StatusTypeDef OV7670_WriteRegList(OV7670_Handle_t *hov7670,
                                         const OV7670_RegVal_t *reg_list) {
    if (reg_list == NULL) {
        return OV7670_INVALID_PARAM;
    }
