...
/* Switches to the low-light sensitivity mode. */
OV7670_StatusTypeDef OV7670_SetNightMode(OV7670_Handle_t *hov7670, bool enable);
/* Forces a fixed test pattern instead of sensor data, for verifying the pipeline. */
