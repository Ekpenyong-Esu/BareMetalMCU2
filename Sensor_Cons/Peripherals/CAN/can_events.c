...
HAL_StatusTypeDef CAN_EnableInterrupts(CAN_Handle_t *hcan) {
    static const uint32_t notifications[] = {
        ...
        CAN_IT_RX_FIFO0_OVERRUN, CAN_IT_RX_FIFO1_OVERRUN,     CAN_IT_ERROR,
        CAN_IT_BUSOFF,           CAN_IT_ERROR_PASSIVE,        CAN_IT_ERROR_WARNING,
    };
...
HAL_StatusTypeDef CAN_DisableInterrupts(CAN_Handle_t *hcan) {
    ...
    const uint32_t notifications = CAN_IT_TX_MAILBOX_EMPTY | CAN_IT_RX_FIFO0_MSG_PENDING |
