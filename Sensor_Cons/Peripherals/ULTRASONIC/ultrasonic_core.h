 ...
 */
ULTRASONIC_StatusTypeDef ULTRASONIC_Init(ULTRASONIC_Handle_t *hultra, TIM_HandleTypeDef *htim,
                                         uint32_t channel, const ULTRASONIC_Pins_t *pins);
...
ULTRASONIC_StatusTypeDef ULTRASONIC_SetTemperature(ULTRASONIC_Handle_t *hultra, int8_t temperature);
