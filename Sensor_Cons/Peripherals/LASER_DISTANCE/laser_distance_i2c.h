 ...
 *          peripheral, always through the device record in the handle.
 *          Not part of the public aggregator.
 ******************************************************************************
 */

#ifndef LASER_DISTANCE_I2C_H
#define LASER_DISTANCE_I2C_H
