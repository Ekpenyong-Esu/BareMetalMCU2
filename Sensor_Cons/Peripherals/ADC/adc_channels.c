...
static const ADC_ChannelMapEntry_t adc_channel_map[] = {
    {ADC_CHANNEL_0, GPIOA, GPIO_PIN_0, "PA0"},  {ADC_CHANNEL_1, GPIOA, GPIO_PIN_1, "PA1"},
    {ADC_CHANNEL_2, GPIOA, GPIO_PIN_2, "PA2"},  {ADC_CHANNEL_3, GPIOA, GPIO_PIN_3, "PA3"},
    {ADC_CHANNEL_4, GPIOA, GPIO_PIN_4, "PA4"},  {ADC_CHANNEL_5, GPIOA, GPIO_PIN_5, "PA5"},
    {ADC_CHANNEL_6, GPIOA, GPIO_PIN_6, "PA6"},  {ADC_CHANNEL_7, GPIOA, GPIO_PIN_7, "PA7"},
    {ADC_CHANNEL_8, GPIOB, GPIO_PIN_0, "PB0"},  {ADC_CHANNEL_9, GPIOB, GPIO_PIN_1, "PB1"},
    {ADC_CHANNEL_10, GPIOC, GPIO_PIN_0, "PC0"}, {ADC_CHANNEL_11, GPIOC, GPIO_PIN_1, "PC1"},
    {ADC_CHANNEL_12, GPIOC, GPIO_PIN_2, "PC2"}, {ADC_CHANNEL_13, GPIOC, GPIO_PIN_3, "PC3"},
    {ADC_CHANNEL_14, GPIOC, GPIO_PIN_4, "PC4"}, {ADC_CHANNEL_15, GPIOC, GPIO_PIN_5, "PC5"},
    {ADC_CHANNEL_TEMPSENSOR, NULL, 0, "TEMP"},  {ADC_CHANNEL_VREFINT, NULL, 0, "VREF"},
    {ADC_CHANNEL_VBAT, NULL, 0, "VBAT"},
};

#define ADC_CHANNEL_MAP_COUNT (sizeof(adc_channel_map) / sizeof(adc_channel_map[0]))
