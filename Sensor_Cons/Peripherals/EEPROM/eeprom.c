...
static const EEPROM_ConfigTypeDef eepromConfigs[] = {
    [EEPROM_TYPE_M24LR64] = {.i2cAddress = EEPROM_I2C_ADDRESS_A01,
                             .i2cAddressAlt = EEPROM_I2C_ADDRESS_A02,
                             .totalSize = EEPROM_SIZE_8KB,
                             .pageSize = EEPROM_PAGESIZE_4,
                             .addressSize = 2},
    [EEPROM_TYPE_M24C01] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                            .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                            .totalSize = EEPROM_SIZE_128B,
                            .pageSize = EEPROM_PAGESIZE_16,
                            .addressSize = 1},
    [EEPROM_TYPE_M24C02] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                            .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                            .totalSize = EEPROM_SIZE_256B,
                            .pageSize = EEPROM_PAGESIZE_16,
                            .addressSize = 1},
    [EEPROM_TYPE_M24C04] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                            .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                            .totalSize = EEPROM_SIZE_512B,
                            .pageSize = EEPROM_PAGESIZE_16,
                            .addressSize = 1},
    [EEPROM_TYPE_M24C08] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                            .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                            .totalSize = EEPROM_SIZE_1KB,
                            .pageSize = EEPROM_PAGESIZE_16,
                            .addressSize = 1},
    [EEPROM_TYPE_M24C16] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                            .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                            .totalSize = EEPROM_SIZE_2KB,
                            .pageSize = EEPROM_PAGESIZE_16,
                            .addressSize = 1},
    [EEPROM_TYPE_M24C32] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                            .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                            .totalSize = EEPROM_SIZE_4KB,
                            .pageSize = EEPROM_PAGESIZE_32,
                            .addressSize = 2},
    [EEPROM_TYPE_M24C64] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                            .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                            .totalSize = EEPROM_SIZE_8KB,
                            .pageSize = EEPROM_PAGESIZE_32,
                            .addressSize = 2},
    [EEPROM_TYPE_M24C128] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                             .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                             .totalSize = EEPROM_SIZE_16KB,
                             .pageSize = EEPROM_PAGESIZE_64,
                             .addressSize = 2},
    [EEPROM_TYPE_M24C256] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                             .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                             .totalSize = EEPROM_SIZE_32KB,
                             .pageSize = EEPROM_PAGESIZE_64,
                             .addressSize = 2},
    [EEPROM_TYPE_M24C512] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                             .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                             .totalSize = EEPROM_SIZE_64KB,
                             .pageSize = EEPROM_PAGESIZE_128,
                             .addressSize = 2},
    [EEPROM_TYPE_AT24C256] = {.i2cAddress = EEPROM_I2C_ADDRESS_BASE,
                              .i2cAddressAlt = EEPROM_I2C_ADDRESS_BASE,
                              .totalSize = EEPROM_SIZE_32KB,
                              .pageSize = EEPROM_PAGESIZE_64,
                              .addressSize = 2}};
...
static EEPROM_StatusTypeDef EEPROM_Probe(EEPROM_HandleTypeDef *handle) {
    ...
    if (EEPROM_IO_Init(handle) != EEPROM_OK) {
        return EEPROM_ERROR;
    }
...
EEPROM_StatusTypeDef EEPROM_Init(EEPROM_HandleTypeDef *handle, I2C_Bus_t *bus) {
    return EEPROM_InitType(handle, bus, EEPROM_TYPE_M24LR64);
}

EEPROM_StatusTypeDef EEPROM_InitType(EEPROM_HandleTypeDef *handle, I2C_Bus_t *bus,
                                     EEPROM_TypeDef type) {
    if (handle == NULL || bus == NULL || type >= EEPROM_TYPE_CUSTOM) {
...
EEPROM_StatusTypeDef EEPROM_InitCustom(EEPROM_HandleTypeDef *handle, I2C_Bus_t *bus,
    ...
    if (handle == NULL || bus == NULL || config == NULL) {
        return EEPROM_INVALID_PARAM;
    }
