...
static const DMA_StreamEntry_t s_streams[] = {
    { DMA1_Stream0, DMA1_Stream0_IRQn, false },
    { DMA1_Stream1, DMA1_Stream1_IRQn, false },
    { DMA1_Stream2, DMA1_Stream2_IRQn, false },
    { DMA1_Stream3, DMA1_Stream3_IRQn, false },
    { DMA1_Stream4, DMA1_Stream4_IRQn, false },
    { DMA1_Stream5, DMA1_Stream5_IRQn, false },
    { DMA1_Stream6, DMA1_Stream6_IRQn, false },
    { DMA1_Stream7, DMA1_Stream7_IRQn, false },
    { DMA2_Stream0, DMA2_Stream0_IRQn, true },
    { DMA2_Stream1, DMA2_Stream1_IRQn, true },
    { DMA2_Stream2, DMA2_Stream2_IRQn, true },
    { DMA2_Stream3, DMA2_Stream3_IRQn, true },
    { DMA2_Stream4, DMA2_Stream4_IRQn, true },
    { DMA2_Stream5, DMA2_Stream5_IRQn, true },
    { DMA2_Stream6, DMA2_Stream6_IRQn, true },
    { DMA2_Stream7, DMA2_Stream7_IRQn, true },
};
