...
/** Time given to the oscillator to restart after a RESET command */
#define MCP2515_RESET_SETTLE_MS 10U
 ...
 */
static MCP2515_Status_t MCP2515_Exchange(MCP2515_Handle_t *hmcp, const uint8_t *header,
                                         uint8_t headerLength, uint8_t *rxData,
...
MCP2515_Status_t MCP2515_ResetDevice(MCP2515_Handle_t *hmcp) {
    ...
    HAL_Delay(MCP2515_RESET_SETTLE_MS);
