...
/**
 * @brief This function handles DMA2 stream5 global interrupt (UART RX).
 *        The UART driver finds the link that was given this stream.
 */
void DMA2_Stream5_IRQHandler(void) {
    UART_DmaStreamIRQHandler(DMA2_Stream5);
}

/**
 * @brief This function handles DMA2 stream7 global interrupt (UART TX).
 *        The UART driver finds the link that was given this stream.
 */
void DMA2_Stream7_IRQHandler(void) {
    UART_DmaStreamIRQHandler(DMA2_Stream7);
}
...
void DMA1_Stream3_IRQHandler(void) {
    MIC_DMA_IRQHandler(DMA1_Stream3);
}
